...
{
    /// <summary>
    /// The options for communication <see cref="MessagingClient"/>.
    /// </summary>
    public class MessagingClientOptions : ClientOptions
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingClientOptions"/>.
        /// </summary>
        public MessagingClientOptions(ServiceVersion version = LatestVersion)
        {
