...
namespace Azure.Communication.Messaging
{
    ...
    public class SendMessageOptions
    {
        ...
        public SendMessageOptions(string channelRegistrationId, string to, string content)
        {
        ...
        /// <param name="content"></param>
        public SendMessageOptions(string channelRegistrationId, string to, Uri mediaUri, string content = null)
        {
            Argument.AssertNotNull(to, nameof(to));
        ...
        public SendMessageOptions(string channelRegistrationId, string to, MessageTemplate template) // type implicitly Template
        {
            Argument.AssertNotNull(to, nameof(to));
